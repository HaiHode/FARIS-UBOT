...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰✠╼━━━━━━❖━━━━━━━✠╯\n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ \n"
        f"[𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌]({IG_ALIVE}) || [{REPO_NAME}](https://github.com/HaiHode/FARIS-UBOT) || [𝐆𝐑𝐎𝐔𝐏]({GROUP_LINK}) \n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"❃ **Modul**           ➥ `{len(modules)}` \n\n"
        f"**▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰**\n"
        f"[{REPO_NAME}](https://github.com/HaiHode/FARIS-UBOT) || [𝗚𝗥𝗢𝗨𝗣]({GROUP_LINK}) || [𝗜𝗡𝗦𝗧𝗔𝗚𝗥𝗔𝗠]({IG_ALIVE})\n"
        f"**▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ **")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def amireallyalive(alive):
    user = await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    await alive.edit("`Hallo guys,aku TeBoo🐻`")
    await asyncio.sleep(1)
    await alive.edit("✨")
    await asyncio.sleep(3)
    output = (
        ...
        f"╰✠╼━━━━━━❖━━━━━━━✠╯ \n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ \n"
        f"[{REPO_NAME}](https://github.com/HaiHode/FARIS-UBOT) || [𝐆𝐑𝐎𝐔𝐏]({GROUP_LINK}) || [𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌]({IG_ALIVE}) \n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
